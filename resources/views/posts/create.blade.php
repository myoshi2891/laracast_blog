        ...
        <x-panel class="max-w-sm mx-auto">
            <form method="POST" action="/admin/posts">
                ...
                <div class="mb-6">
                    ...
                    <textarea class="border border-gray-400 p-2 w-full" type="text" name="excerpt" id="excerpt" required>{{ old('excerpt') }}
                    </textarea>
                ...
                <div class="mb-6">
                    ...
                    <textarea class="border border-gray-400 p-2 w-full" type="text" name="body" id="body" required>{{ old('body') }}
                    </textarea>
